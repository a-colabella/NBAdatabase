...
def runAddPlayer(connection, table, rt):
    ...
    fg_entry = Spinbox(add_window, from_=0, to=1, increment=.01, format="%.02f").grid(row=5,column=2)
    threeP_label = Label(add_window, text="3P%: ").grid(row=6, column=1)
    threeP_entry = Spinbox(add_window, from_=0, to=1, increment=.01, format="%.02f").grid(row=6,column=2)
    ft_label = Label(add_window, text="FT%: ").grid(row=7, column=1)
    ft_entry = Spinbox(add_window, from_=0, to=1, increment=.01, format="%.02f").grid(row=7,column=2)
    rbs_label = Label(add_window, text="Rbs: ").grid(row=8, column=1)
    rbs_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=8,column=2)
    ast_label = Label(add_window, text="Ast: ").grid(row=9, column=1)
    ast_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=9,column=2)
    stl_label = Label(add_window, text="Stl: ").grid(row=10, column=1)
    stl_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=10,column=2)
    blk_label = Label(add_window, text="Blk: ").grid(row=11, column=1)
    blk_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=11,column=2)
    TO_label = Label(add_window, text="TO: ").grid(row=12, column=1)
    TO_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=12,column=2)
    Pts_label = Label(add_window, text="Pts: ").grid(row=13, column=1)
    Pts_entry = Spinbox(add_window, from_=0, to=100, increment=.01, format="%.02f").grid(row=13,column=2)
